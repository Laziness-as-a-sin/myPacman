...
QT_MOC_LITERAL(1, 7, 15), // "signalCheckItem"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 14), // "QGraphicsItem*"
QT_MOC_LITERAL(4, 39, 4), // "item"
QT_MOC_LITERAL(5, 44, 10), // "MoveOnTime"
QT_MOC_LITERAL(6, 55, 9) // "NextFrame"

    },
    "PacMan\0signalCheckItem\0\0QGraphicsItem*\0"
    "item\0MoveOnTime\0NextFrame"
};
...
void PacMan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalCheckItem((*reinterpret_cast< QGraphicsItem*(*)>(_a[1]))); break;
        case 1: _t->MoveOnTime(); break;
        ...
        {
            typedef void (PacMan::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PacMan::signalCheckItem)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PacMan::signalCheckItem(QGraphicsItem * _t1)
{
